package com.main_project.game_service.exceptions.enums;
...
public enum ErrorCode {
    ...
    GAME_NOT_EXISTED(1006, "Game not existed", HttpStatus.BAD_REQUEST),
    PLATFORM_NOT_EXISTED(1007, "Platform not existed", HttpStatus.BAD_REQUEST);
